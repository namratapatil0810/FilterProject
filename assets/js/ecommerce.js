    ...
    do {
      !(function() {
        for (var e, n = 0; t.groups[n]; n++)
          (e = t.groups[n]).active[e.tracker] && (r += e.active[e.tracker]),
            n === t.groups.length - 1 && (t.outputArray.push(r), (r = ""), i());
      })();
    } while (
      !e &&
      (function() {
        for (var r = 0, e = 0; t.groups[e]; e++)
          !1 === t.groups[e].tracker && r++;
        return r < t.groups.length;
      })()
    );
    (t.outputString = t.outputArray.join()),
      !t.outputString.length && (t.outputString = "all"),
      t.$container.mixItUp("isLoaded") &&
        t.$container.mixItUp("filter", t.outputString);
  }
};
$(function() {
  var t = $("#SortSelect"),
  ...
  checkboxFilter.init(),
    r.mixItUp({
      controls: { enable: !1 },
      animation: { easing: "cubic-bezier(0.86, 0, 0.07, 1)", duration: 600 }
    }),
